...
namespace Assets.BringBackSociety.Tests
{
  ...
  public class TargetLocatorTests
  {
    ...
    {
      _locator.UpdatePosition(100, 100);
    ...
    {
      _locator.UpdatePosition(57, 50);
      Assert.AreEqual(40, _locator.Strength, 3);

      _locator.UpdatePosition(50, 57);
      Assert.AreEqual(40, _locator.Strength, 3);

      _locator.UpdatePosition(43, 50);
      Assert.AreEqual(40, _locator.Strength, 3);

      _locator.UpdatePosition(50, 43);
      Assert.AreEqual(40, _locator.Strength, 3);
    }
